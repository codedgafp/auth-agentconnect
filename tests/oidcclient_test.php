 ...
 * @group office365
 */
class auth_agentconnect_oidcclient_testcase extends \advanced_testcase {
    /**
    ...
    public function test_creds_getters_and_setters() {
        $httpclient = new \auth_agentconnect\tests\mockhttpclient();
        $client = new \auth_agentconnect\tests\mockoidcclient($httpclient);
