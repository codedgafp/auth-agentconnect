 ...
 *
 * @package auth_agentconnect\adminsetting
 */
class auth_agentconnect_admin_setting_label extends admin_setting {
    private $label;

    /**
     * auth_agentconnect_admin_setting_static constructor.
     *
     * @param $name
     * @param $label
     * @param $visiblename
