...
/**
 * Implementation of \auth_agentconnect\httpclientinterface using Moodle CURL.
 */
class httpclient extends \curl implements \auth_agentconnect\httpclientinterface {
    /**
    ...
    protected function get_plugin_version() {
        global $CFG;
        $plugin = new \stdClass;
        require_once($CFG->dirroot.'/auth/agentconnect/version.php');
