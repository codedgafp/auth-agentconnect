...
$string['pluginname'] = 'Agent Connect';
$string['auth_agentconnectdescription'] = 'Le plug-in OpenID Connect fournit une fonctionnalité SSO avec des fournisseurs d\'identité configurables.';
...
$string['privacy:metadata:auth_agentconnect'] = 'Authentification OpenID Connect';
$string['privacy:metadata:auth_agentconnect_prevlogin'] = 'Méthodes de connexion précédentes pour annuler les connexions Microsoft 365';
$string['privacy:metadata:auth_agentconnect_prevlogin:userid'] = 'L\'identifiant de l\'utilisateur Moodle';
$string['privacy:metadata:auth_agentconnect_prevlogin:method'] = 'La méthode de connexion précédente';
$string['privacy:metadata:auth_agentconnect_prevlogin:password'] = 'Le mot de passe précédent de l\'utilisateur (chiffré)';
$string['privacy:metadata:auth_agentconnect_token'] = 'Jetons OpenID Connect';
$string['privacy:metadata:auth_agentconnect_token:oidcuniqid'] = 'L\'identifiant utilisateur unique de OIDCs';
$string['privacy:metadata:auth_agentconnect_token:username'] = 'Le nom d\'utilisateur de l\'utilisateur Moodle';
$string['privacy:metadata:auth_agentconnect_token:userid'] = 'Le ID de l\'utilisateur Moodle';
$string['privacy:metadata:auth_agentconnect_token:oidcusername'] = 'Le nom d\'utilisateur de l\'utilisateur OIDC';
$string['privacy:metadata:auth_agentconnect_token:scope'] = 'La portée du jeton';
$string['privacy:metadata:auth_agentconnect_token:tokenresource'] = 'La ressource du jeton';
$string['privacy:metadata:auth_agentconnect_token:authcode'] = 'Le code d\'authentification du jeton';
$string['privacy:metadata:auth_agentconnect_token:token'] = 'Le jeton';
$string['privacy:metadata:auth_agentconnect_token:expiry'] = 'L\'expiration du jeton';
$string['privacy:metadata:auth_agentconnect_token:refreshtoken'] = 'Le jeton de rafraîchissement';
$string['privacy:metadata:auth_agentconnect_token:idtoken'] = 'Le jeton ID';
...
// Added by Edunao.
$string['cfg_userinfo_key'] = 'Userinfo';
$string['cfg_userinfo_desc'] = 'Si besoin, URL supplémentaire où récupérer les données utilisateurs';
$string['cfg_matchemail_key'] = 'Correspondre l\'email ?';
$string['cfg_matchemail_desc'] = 'Fait correspondre l\'utilisateur en fonction de son email et non de son username';

// Patch Edunao : force password change for new accounts.
$string['cfg_forcepasswordchange_key'] = 'Forcer le changement de mot de passe';
$string['cfg_forcepasswordchange_desc'] = 'Si activé, force le changement de mot de passe pour les nouveaux comptes';

// Patch Edunao : disable password change for existing account.
$string['cfg_disableforcepasswordchange_key'] = 'Désactive le changement de mot de passe pour les comptes existants';
$string['cfg_disableforcepasswordchange_desc'] = 'Si activé, desactive le changement de mot de passe pour les comptes existants';

$string['cfg_authmethod_key'] = 'Méthode d\'authentification des nouveaux comptes';
$string['cfg_authmethod_desc'] = 'Choisir la méthode d\'authentification des nouveaux comptes';
