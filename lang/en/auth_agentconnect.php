...
$string['auth_agentconnectdescription'] = 'The OpenID Connect authentication plugin provides single-sign-on functionality using configurable identity providers.';
...
$string['cfg_forcepasswordchange_key'] = 'Force password change';
$string['cfg_forcepasswordchange_desc'] = 'If enabled, force password change for new accounts';

// Patch Edunao : disable password change for existing account.
$string['cfg_disableforcepasswordchange_key'] = 'Disable password change for existing accounts';
$string['cfg_disableforcepasswordchange_desc'] = 'If enabled, disable password change for existing accounts';

$string['cfg_authmethod_key'] = 'Auth method for new accounts';
$string['cfg_authmethod_desc'] = 'Choose the authentification method for new accounts';
...
$string['privacy:metadata:auth_agentconnect'] = 'OpenID Connect Authentication';
$string['privacy:metadata:auth_agentconnect_prevlogin'] = 'Previous login methods to undo Microsoft 365 connections';
$string['privacy:metadata:auth_agentconnect_prevlogin:userid'] = 'The ID of the Moodle user';
$string['privacy:metadata:auth_agentconnect_prevlogin:method'] = 'The previous login method';
$string['privacy:metadata:auth_agentconnect_prevlogin:password'] = 'The previous (encrypted) user password field.';
$string['privacy:metadata:auth_agentconnect_token'] = 'OpenID Connect tokens';
$string['privacy:metadata:auth_agentconnect_token:oidcuniqid'] = 'The OIDC unique user identifier.';
$string['privacy:metadata:auth_agentconnect_token:username'] = 'The username of the Moodle user';
$string['privacy:metadata:auth_agentconnect_token:userid'] = 'The user ID of the Moodle user';
$string['privacy:metadata:auth_agentconnect_token:oidcusername'] = 'The username of the OIDC user';
$string['privacy:metadata:auth_agentconnect_token:scope'] = 'The scope of the token';
$string['privacy:metadata:auth_agentconnect_token:tokenresource'] = 'The resource of the token';
$string['privacy:metadata:auth_agentconnect_token:authcode'] = 'The auth code for the token';
$string['privacy:metadata:auth_agentconnect_token:token'] = 'The token';
$string['privacy:metadata:auth_agentconnect_token:expiry'] = 'The token expiry';
$string['privacy:metadata:auth_agentconnect_token:refreshtoken'] = 'The refresh token';
$string['privacy:metadata:auth_agentconnect_token:idtoken'] = 'The ID token';
...
$string['settings_fieldmap_field_usual_name'] = 'Usual Name';
...
$string['cfg_userinfo_desc'] = 'If necessary, additional URL to retrieve user data';
$string['cfg_matchemail_key'] = 'Match email ?';
$string['cfg_matchemail_desc'] = 'Match user based on email, not username';